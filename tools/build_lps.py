...
MODULES = {
    'crm': {
        ...
        'faqs': [
            ...
            ('Quanto custa por usuário?', 'O Orbit precifica por porte de empresa, não por usuário do CRM. <strong>Plano Smart R$ 2.200/mês</strong> (até 50 colaboradores · toda a plataforma com 12 agentes IA inclusos). Sem fidelidade, sem cobrar por seat. Trial 3 dias grátis.'),
    ...
    'estrategico': {
        ...
        'faqs': [
            ...
            ('Quanto custa?', 'Plano <strong>Smart R$ 2.200/mês</strong> (até 50 colaboradores · todos os módulos). Sem fidelidade, sem cobrar por agente IA, sem pegadinha de seat. Trial 3 dias grátis. Plano anual: 20% de desconto.'),
            ('Quanto tempo até começar a usar?', 'Onboarding em <strong>7 dias</strong>. Treinamento inicial em grupo de empresários (troca de experiência ajuda muito). Tira-dúvidas semanal ao vivo. Não é ERP — não vai levar 3, 4, 5 meses pra implementar.'),
            ('Olívia atende via WhatsApp?', 'Sim. A Olívia (agente cérebro) coordena os <strong>12 agentes IA</strong> e atende via WhatsApp 24/7 — todo colaborador pode perguntar, criar tarefa, ver indicador ou pedir análise direto pelo WhatsApp. Não precisa abrir app.'),
        ],
