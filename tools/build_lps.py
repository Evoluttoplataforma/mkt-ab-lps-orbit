...
MODULES = {
    'crm': {
        ...
        'hero_a_h1': 'Tire o comercial do <span class="text-primary">WhatsApp pessoal</span> — antes que o lead suma.',
        'hero_a_sub': 'Pipeline visual, análise IA por lead, automação e WhatsApp integrado. O CRM que cresceu junto com a empresa B2B — sem perder a agilidade do WhatsApp.',
        'hero_b_h1': 'Tire o comercial do <em>WhatsApp pessoal</em> — antes que o lead suma.',
        'hero_b_sub': 'Pipeline visual, análise IA por lead, automação e WhatsApp integrado. O CRM que cresceu junto com a empresa B2B — sem perder a agilidade do WhatsApp.',
        ...
        'benefits_headline': 'O CRM que cresceu junto com a empresa B2B — não é mais um sistema <span class="text-primary">estático</span> que não conversa com nada',
        'benefits_headline_b': 'O CRM que cresceu junto com a empresa B2B — não é mais um sistema <em>estático</em> que não conversa com nada',
        'benefits': [
        ...
        'faqs': [
            ...
            ('Por usuário ou por empresa?', 'O Orbit precifica por <strong>porte de empresa</strong>, não por usuário do CRM. Sem cobrar por seat, sem cobrar por agente IA — toda a plataforma e os 12 agentes ficam inclusos. Trial 3 dias grátis sem cartão. Valor exato: fale com a Olívia.'),
            ('Quanto tempo até começar a usar?', 'Onboarding em <strong>7 dias</strong>. Treinamento inicial em grupo de empresários (troca de experiência ajuda muito). Tira-dúvidas semanal ao vivo. Não é ERP — não vai levar 3, 4, 5 meses pra implementar.'),
            ('Olívia atende via WhatsApp?', 'Sim. A Olívia (agente cérebro) coordena os <strong>12 agentes IA</strong> e atende via WhatsApp 24/7 — todo colaborador pode perguntar, criar tarefa, ver indicador ou pedir análise direto pelo WhatsApp. Não precisa abrir app.'),
    ...
    'estrategico': {
        ...
        'hero_a_h1': 'Seu plano estratégico já está <span class="text-primary">engavetado</span>?',
        'hero_a_sub': 'BSC, OKR, SWOT e inteligência de mercado em uma plataforma só. Cada objetivo estratégico vira KPI e tarefa real — auditável, mensurável e conectado à execução do time.',
        'hero_b_h1': 'Seu plano estratégico já está <em>engavetado</em>?',
        'hero_b_sub': 'BSC, OKR, SWOT e inteligência de mercado em uma plataforma só. Cada objetivo estratégico vira KPI e tarefa real — auditável, mensurável e conectado à execução do time.',
        ...
        'benefits_headline': 'Estratégia que <span class="text-primary">executa</span>, não que decora parede — fim do BSC em PowerPoint',
        'benefits_headline_b': 'Estratégia que <em>executa</em>, não que decora parede — fim do BSC em PowerPoint',
        'benefits': [
        ...
        'faqs': [
            ...
            ('Como funciona a precificação?', 'Por <strong>porte de empresa</strong>, não por usuário. Sem fidelidade, sem cobrar por agente IA, sem pegadinha de seat — toda a plataforma com 12 agentes inclusos. Trial 3 dias grátis sem cartão. Valor exato: fale com a Olívia no chat.'),
            ('Quanto tempo até começar a usar?', 'Onboarding em <strong>7 dias</strong>. Treinamento inicial em grupo de empresários (troca de experiência ajuda muito). Tira-dúvidas semanal ao vivo. Não é ERP — não vai levar 3, 4, 5 meses pra implementar.'),
            ('Olívia atende via WhatsApp?', 'Sim. A Olívia (agente cérebro) coordena os <strong>12 agentes IA</strong> e atende via WhatsApp 24/7 — todo colaborador pode perguntar, criar tarefa, ver indicador ou pedir análise direto pelo WhatsApp. Não precisa abrir app.'),
        ],
    ...
    'indicadores': {
        ...
        'hero_a_h1': 'Sua diretoria ainda discute qual é o <span class="text-primary">número certo</span>?',
        'hero_a_sub': '22+ KPIs prontos, conectores nativos com seus módulos e drill-down até a tarefa. Para empresas que cansaram de cada área usar uma planilha diferente de "verdade única".',
        'hero_b_h1': 'Sua diretoria ainda discute qual é o <em>número certo</em>?',
        'hero_b_sub': '22+ KPIs prontos, conectores nativos com seus módulos e drill-down até a tarefa. Para empresas que cansaram de cada área usar uma planilha diferente de "verdade única".',
        ...
        'benefits_headline': 'Painel único, não 5 planilhas — fim da <span class="text-primary">"salada mista de informações"</span>',
        'benefits_headline_b': 'Painel único, não 5 planilhas — fim da <em>"salada mista de informações"</em>',
        'benefits': [
    ...
    'processos': {
        ...
        'hero_a_h1': 'Quando seu colaborador sai, o <span class="text-primary">processo sai junto</span>?',
        'hero_a_sub': 'BPM com agente IA que cria fluxos a partir de descrição. Conformidade ISO 9001, BPMN, cadeia de valor e instruções de trabalho numa plataforma só. Sem virar projeto de 18 meses.',
        'hero_b_h1': 'Quando seu colaborador sai, o <em>processo sai junto</em>?',
        'hero_b_sub': 'BPM com agente IA que cria fluxos a partir de descrição. Conformidade ISO 9001, BPMN, cadeia de valor e instruções de trabalho numa plataforma só. Sem virar projeto de 18 meses.',
        ...
        'benefits_headline': 'Processo vivo, não manual em PDF — fim da dependência de <span class="text-primary">"quem está há mais tempo"</span>',
        'benefits_headline_b': 'Processo vivo, não manual em PDF — fim da dependência de <em>"quem está há mais tempo"</em>',
        'benefits': [
    ...
    'pessoas': {
        ...
        'hero_a_h1': 'Sua planilha de RH <span class="text-primary">estourou</span> faz tempo, né?',
        'hero_a_sub': 'ATS com IA, organograma multi-modo, PDI conectado a OKR e trilhas por cargo. Para empresas 30+ funcionários que cansaram da colcha de retalhos de RH.',
        'hero_b_h1': 'Sua planilha de RH <em>estourou</em> faz tempo, né?',
        'hero_b_sub': 'ATS com IA, organograma multi-modo, PDI conectado a OKR e trilhas por cargo. Para empresas 30+ funcionários que cansaram da colcha de retalhos de RH.',
        ...
        'benefits_headline': 'RH conectado ao negócio, não isolado em <span class="text-primary">planilha</span>',
        'benefits_headline_b': 'RH conectado ao negócio, não isolado em <em>planilha</em>',
        'benefits': [
    ...
    'projetos': {
        ...
        'hero_a_h1': 'Descobriu o atraso quando o <span class="text-primary">cliente reclamou</span>?',
        'hero_a_sub': 'Cards, Kanban, Lista e Gantt em uma só ferramenta. Agente IA cria projeto a partir de descrição. Conectado a CRM, RH e Estratégico — sem export/import.',
        'hero_b_h1': 'Descobriu o atraso quando o <em>cliente reclamou</em>?',
        'hero_b_sub': 'Cards, Kanban, Lista e Gantt em uma só ferramenta. Agente IA cria projeto a partir de descrição. Conectado a CRM, RH e Estratégico — sem export/import.',
        ...
        'benefits_headline': 'PMO que conversa com o resto da empresa — fim do projeto <span class="text-primary">isolado em Trello</span>',
        'benefits_headline_b': 'PMO que conversa com o resto da empresa — fim do projeto <em>isolado em Trello</em>',
        'benefits': [
    ...
    'canal-orbit': {
        ...
        'hero_a_h1': 'Sua consultoria ainda entrega <span class="text-primary">PDF</span>?',
        'hero_a_sub': 'Plataforma whitelabel com agentes de IA inclusos. Modelo de Consultoria Recorrente Passiva (CRP) que gera receita recorrente sem expandir o time. Como Templum, Bruno Lozano e outros consultores já fazem.',
        'hero_b_h1': 'Sua consultoria ainda entrega <em>PDF</em>?',
        'hero_b_sub': 'Plataforma whitelabel com agentes de IA inclusos. Modelo de Consultoria Recorrente Passiva (CRP) que gera receita recorrente sem expandir o time. Como Templum, Bruno Lozano e outros consultores já fazem.',
        ...
        'benefits_headline': 'Por que consultorias entram no Canal Orbit — fim de <span class="text-primary">entregar e ir embora</span>',
        'benefits_headline_b': 'Por que consultorias entram no Canal Orbit — fim de <em>entregar e ir embora</em>',
        'benefits': [
        ...
        'faqs': [
            ...
            ('Quanto tempo pra começar a entregar?', '<strong>7 dias</strong> de onboarding pra consultoria. Cada cliente seu também roda em 7 dias — não 3 meses como consultoria tradicional.'),
